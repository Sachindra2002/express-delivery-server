...
<div>
    ...
    <div class="send-package-button" style="float: right">
        <div>
            <a type="button" data-toggle="modal" data-target="#openDisputeModal">Add Driver</a>
        </div>
    </div>
    <div style="margin-top: 100px">
        <div>
            ...
            %>
            <div style="margin-right: 30px; margin-top: 100px; margin-left: 30px" class="alert alert-secondary" role="alert">
            ...
            <div class="homepage-row" style=" margin-right: 50px">
                <c:forEach var="driver" items="${driver_list}">
                    <div class="card"
                        ...
                        <div class="card-body">
                            <h5 style="float: left" class="card-title">${driver.getFirstName()} ${driver.getLastName()}</h5>
                        ...
                        <div>
                            <form method="get" action="/#">
                                <input type="hidden" name="mailId" value="${driver .driverDetail.getDriverId()}">
                                <button style="float: right; margin: 10px" type="submit" class="btn btn-secondary">View Driver
                                </button>
                            </form>
                        </div>
                        <div class="card-header" style="border-radius: 10px">
                            ...
                            <p class="card-text"
                               style="float: right; font-weight: bold; margin-right: 10px; margin-top: 5px">Driver ID</p>
                            <br/><br/>
                        </div>
                    </div>
                </c:forEach>

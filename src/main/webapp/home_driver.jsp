...
<div>
            ...
            <c:forEach var="mail" items="${assigned_packages}">
                <div class="card" style="border-radius: 10px; margin-top: 10px">
                    <div class="card-body">
                        ...
                        <button style="float: right" type="button" class="btn btn-info">Accept</button>
    ...
    <div class="package-stats">
        ...
        <div style="margin-top: 50px">
            <%
                List<MailDto> mail2 = new ArrayList<>();
                try {
                    mail2 = (List<MailDto>) request.getAttribute("accepted_packages");
                } catch (Exception e) {
                    e.printStackTrace();
                }

                if (mail2 != null && mail2.size() <= 0) {
            %>
            <div style="margin-right: 30px; margin-top: 30px; margin-left: 30px" class="alert alert-secondary"
                 role="alert">
    ...
    <div class="package-stats-2">
        ...
        <div style="margin-top: 50px">
            <%
                List<MailDto> mail3 = new ArrayList<>();
                try {
                    mail3 = (List<MailDto>) request.getAttribute("accepted_packages");
                } catch (Exception e) {
                    e.printStackTrace();
                }

                if (mail3 != null && mail3.size() <= 0) {
            %>
            <div style="margin-right: 30px; margin-top: 30px; margin-left: 30px" class="alert alert-secondary"
                 role="alert">
                No Accepted Shipments
